...
d3.csv("/datasets/data.csv", function(err,healthData){
  ...
  yMin = d3.min(healthData,function(data){
          return +data.phy_act * 0.98;
  });

  yMax = d3.max(healthData,function(data){
        return +data.phy_act * 1.02;
  });
...
// initialize tooltip
  var toolTip = d3
                ...
                .html(function(data){
                  ...
                  var phyAct = +data.phys_act;
                  return(
                    stateName + '<br>Poverty:' + pov + '%<br> Physically Active: '+ phyAct +'%'
                  );
                });
// Create toolTip
      chart.call(toolTip);
      ...
      chart.selectAll("circle")
           ...
           .attr("cy", function(data, index){
              return yLinearScale(data.phy_act)
           })
           .attr("r","15")
           .attr("fill","lightblue")
